...
import { API_CONFIG } from '../utlis/constants'
...
export class WebSocketService {
  ...
  private setupEventListeners(): void {
    ...
    this.ws.onopen = () => {
      ...
      console.log('Re-subscribing to gates:', Array.from(this.subscriptions))
  ...
  private handleMessage(message: WebSocketMessage): void {
    switch (message.type) {
      case 'zone-update':
        console.log('Handling zone update:', message)
        this.onZoneUpdate?.(message)
        break
      case 'admin-update':
        console.log('Handling admin update:', message)
  ...
  subscribeToGate(gateId: string): void {
    console.log('Adding gate subscription:', gateId)
    ...
    if (this.ws?.readyState === WebSocket.OPEN) {
      ...
      console.log('WebSocket not ready, subscription will be sent when connected')
    }
  }

  unsubscribeFromGate(gateId: string): void {
    console.log('Removing gate subscription:', gateId)
